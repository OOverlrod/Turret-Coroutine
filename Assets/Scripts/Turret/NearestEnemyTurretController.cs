...
namespace TurretDemo
{
    ...
    public sealed class NearestEnemyTurretController : BaseTurretController
    {
        ...
        [Header("Coroutine Attack Effect")]
        [SerializeField] private CoroutineTurretAttack attackEffect;
        ...
        protected override void OnProjectileFired(GameObject projectileInstance)
        {
            if (attackEffect != null)
            {
                attackEffect.PlayAttackRecoil();
            }
        }
    }
}
